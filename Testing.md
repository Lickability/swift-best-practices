...
#### Codable Models
Unit testing the functionality of the `Codable` protocol is unnecessary, unless the implementation of the `Codable` protocol is overriden by your model. One common occurrence of this is when testing the decoding or encoding of date information from an API. In such cases, you should write unit tests to verify that the `Codable` implementation has been written successfully.
